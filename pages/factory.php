...
<div class="card mt-6">
    <div class="flex justify-between items-center mb-4">
        <h3 class="text-lg font-semibold">Biểu Đồ Trọng Lượng Các Line</h3>
        <div class="flex gap-2">
    <button id="weightBtn5min" class="px-4 py-2 bg-blue-500 text-white rounded">Trend 5p/Lần</button>
    <button id="weightBtnHour" class="px-4 py-2 bg-gray-500 text-white rounded">Trend 1h/Lần</button>
    <button id="weightBtnShift" class="px-4 py-2 bg-gray-500 text-white rounded">Theo Ca</button>
</div>
    </div>
...
<div class="card mt-6">
    ...
    <h3 class="text-lg font-semibold mb-4">Downtime Xưởng</h3>

    <div class="chart-container" style="height: 390px;"> <!-- Thêm fixed height -->
    ...
    <div class="table-container relative" style="height: 350px; overflow-y: auto;">
        <table class="min-w-full">
            <thead class="sticky top-0 bg-[#4472C4]">
                <tr>
                    <th class="px-4 py-2 text-left text-white border border-[#8EA9DB]">Time</th>
                    <th class="px-4 py-2 text-left text-white border border-[#8EA9DB]">L1_Hấp</th>
                    <th class="px-4 py-2 text-left text-white border border-[#8EA9DB]">L1_Chiên</th>
